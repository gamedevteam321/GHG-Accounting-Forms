#!/usr/bin/env python3
"""
Script to create Business Travel DocTypes for the GHG Accounting Forms.
...
def ensure_doctype(name, fields, module_hint="Climoro Onboarding"):
    """Create a DocType if it doesn't exist"""
...
def main():
    """Create all Business Travel DocTypes"""
    ...
    try:
        ...
        print("✅ Business Travel DocTypes created successfully!")
        
    except Exception as e:
        print(f"❌ Error while creating Business Travel DocTypes: {str(e)}")
        sys.exit(1)
