...
def seed_carbon_defaults():
    ...
    materials = [
        ...
        ("Blast Furnace Gas", 0.17, "gas"),
        ("Charcoala", 0.91, "solid"),
        ("Coal1", 0.67, "solid"),
        ("Coal tar", 0.62, "liquid"),
        ("Coke", 0.83, "solid"),
        ("Coke Oven gas", 0.47, "gas"),
        ("Coking Coal", 0.73, "solid"),
        ("Direct reduced Iron (DRI)", 0.02, "solid"),
        ("Dolomite", 0.13, "solid"),
        ("EAF Carbon Electrodes2", 0.82, "solid"),
        ("EAF Charge Carbon3", 0.83, "solid"),
        ("Fuel Oil4", 0.86, "liquid"),
        ("Residual fuel oil", 0.85, "liquid"),
        ("Gas Coke", 0.83, "solid"),
        ("Hot Briquetted iron", 0.02, "solid"),
        ("Limestone", 0.12, "solid"),
        ("Natural Gas", 0.73, "gas"),
        ("Oxygen Steel Furnace Gas", 0.35, "gas"),
        ("Petroleum Coke", 0.87, "solid"),
        ("Purchased pig Iron", 0.04, "solid"),
        ("Scrap Iron", 0.04, "solid"),
        ("Steel", 0.01, "solid"),
    ]
