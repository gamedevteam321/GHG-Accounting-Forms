"""
Offsite Coke Production Emissions DocType Creator
Stores daily entries for offsite coke production CO2 and CH4 emissions
"""
...
# Main execution
try:
    print("🚀 Creating Offsite Coke Production Emissions DocType...")
    ...
    fields = [
        ...
        # Coke Produced Offsite
        {"fieldname": "coke_produced_offsite_amount", "label": "Coke Produced Offsite Amount (t)", "fieldtype": "Float", "in_list_view": 0},
        {"fieldname": "coke_produced_offsite_carbon_content", "label": "Coke Offsite Carbon Content", "fieldtype": "Float", "read_only": 1, "precision": 4, "default": 0.83},
        
        # Coke Oven Gas Produced Offsite
        {"fieldname": "coke_oven_gas_offsite_amount", "label": "Coke Oven Gas Offsite Amount (t)", "fieldtype": "Float", "in_list_view": 0},
        {"fieldname": "coke_oven_gas_offsite_carbon_content", "label": "COG Offsite Carbon Content", "fieldtype": "Float", "read_only": 1, "precision": 4, "default": 0.47},
        ...
        # CH4 Inputs
        {"fieldname": "ch4_coke_produced_tonnes", "label": "Coke Produced Offsite (t)", "fieldtype": "Float", "in_list_view": 0},
        ...
        # CH4 Total
        {"fieldname": "ch4_emissions_kg", "label": "Total CH4 Emissions (kg)", "fieldtype": "Float", "read_only": 1, "in_list_view": 1, "precision": 5},
    ]
    
    ensure_doctype("Offsite Coke Production Emissions", fields)
    print("✅ Offsite Coke Production Emissions DocType ensured.")
    
except Exception as e:
    print("❌ Error ensuring Offsite Coke Production Emissions DocType:", str(e))
    print(frappe.get_traceback())
