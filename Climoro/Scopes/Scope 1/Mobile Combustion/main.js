...
(function() {
    ...
    function buildFilterBar(done) {
        ...
        bar.querySelector('.filter-apply-btn').addEventListener('click', () => {
            ...
            console.log('Mobile Combustion Filter values:', {
        ...
        bar.querySelector('.filter-clear-btn').addEventListener('click', () => {
            ...
            console.log('Mobile Combustion Date filters cleared');
            loadExistingData();
        });
    ...
    async function loadExistingData() {
        ...
        function applyDateFilter(records) {
            ...
            console.log('Mobile Combustion: Applying client-side date filtering...');
        ...
        function renderFuelRows(records) {
            ...
            console.log('Mobile Combustion Fuel: Original records:', records.length, 'Filtered records:', filteredRecords.length);
        ...
        function renderTransRows(records) {
            ...
            // Apply client-side date filtering
            const filteredRecords = applyDateFilter(records);
            console.log('Mobile Combustion Transportation: Original records:', records.length, 'Filtered records:', filteredRecords.length);
