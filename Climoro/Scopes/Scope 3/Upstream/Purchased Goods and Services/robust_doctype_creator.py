...
# This script will delete, recreate, and properly configure all DocTypes

print("🚀 Starting robust DocType creation and visibility setup...")
...
# Step 1: Delete existing DocTypes
...
# Step 2: Create new DocTypes with proper visibility
...
# Step 4: Force database update for visibility
...
print(f"\n🎉 Process completed!")
if all_exist:
    print(f"✅ All DocTypes are ready and visible!")
    ...
    print(f"❌ Some DocTypes are still missing or not visible.")
