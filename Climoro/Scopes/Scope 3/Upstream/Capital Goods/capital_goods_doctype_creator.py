...
# This script will create Capital Goods DocTypes analogous to Purchased Goods and Services

print("🚀 Starting Capital Goods DocType creation...")
...
if all_exist:
    ...
    print(f"❌ Some DocTypes are still missing. Please check errors above.")
