(function(){
    ...
    function addDisplayRow(entryRow, tab){ 
        ...
        if (!applyDateFilter(dateVal)) {
            console.log('Employee Commuting: Record filtered out by date range');
    ...
    function applyDateFilter(recordDate) {
        ...
        console.log('Employee Commuting: Applying client-side date filtering...');
    ...
    function buildFilterBar(done){ 
        const container = scopeRoot.querySelector('.employee-commuting-container'); 
        ...
        bar.querySelector('.filter-apply-btn')?.addEventListener('click', ()=>{
            ...
            console.log('Employee Commuting Filter values:', {
        ...
        bar.querySelector('.filter-clear-btn')?.addEventListener('click', ()=>{
            ...
            console.log('Employee Commuting Date filters cleared');
            container.querySelectorAll('.data-display-row').forEach(r=>r.remove());
        });
