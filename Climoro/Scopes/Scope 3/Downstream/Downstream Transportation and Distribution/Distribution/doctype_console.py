...
print("🚀 Creating Downstream Distribution DocTypes...")

required_doctypes = [
    {
        "name": "Downstream Distribution Site Specific Item",
        "title_field": "description",
        "search_fields": "date,description",
        "field_order": ["s_no","date","description","activity","unit","ef","ef_unit","co2e"],
        "fields": [
            ...
            {"fieldname":"ef","label":"Emission Factor","fieldtype":"Data","read_only":1,"default":"Calculated"},
            {"fieldname":"ef_unit","label":"EF Unit","fieldtype":"Data","read_only":1,"default":"N/A"},
            {"fieldname":"co2e","label":"Calculated Emissions (CO2e)","fieldtype":"Float","in_list_view":1,"read_only":1},
        ],
    },
    {
        "name": "Downstream Distribution Average Data Item",
        "title_field": "description",
        "search_fields": "date,description",
        "field_order": ["s_no","date","description","volume_days","unit","ef","ef_unit","co2e"],
        "fields": [
            {"fieldname":"s_no","label":"S No","fieldtype":"Int","in_list_view":1},
            {"fieldname":"date","label":"Date","fieldtype":"Date","in_list_view":1},
            {"fieldname":"description","label":"Description","fieldtype":"Data","in_list_view":1},
            {"fieldname":"volume_days","label":"Activity Data (Volume: Days Stored)","fieldtype":"Float"},
...
frappe.clear_cache()
frappe.db.commit()
print(f"🎉 Done. Created {created} Distribution DocTypes (others already existed).")
