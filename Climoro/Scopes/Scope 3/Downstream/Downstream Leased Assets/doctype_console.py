...
# In console: exec(open(r"/Users/shobhit/Documents/Projects/Frappe/climoro-project/bench-dev/scope_code/Scope 3/Downstream Leased Assets/doctype_console.py").read())
