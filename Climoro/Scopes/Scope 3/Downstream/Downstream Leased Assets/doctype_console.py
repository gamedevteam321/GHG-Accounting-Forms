...
required_doctypes = [
    {
        ...
        "field_order": ["s_no","date","asset_id","source","activity","unit","ef","ef_unit","co2e"],
        "fields": [
    ...
    },
    {
        ...
        "field_order": ["s_no","date","asset_id","lessee_emission","unit","share","co2e"],
        "fields": [
            {"fieldname":"s_no","label":"S No","fieldtype":"Int","in_list_view":1},
            {"fieldname":"date","label":"Date","fieldtype":"Date","in_list_view":1},
            {"fieldname":"asset_id","label":"Leased Asset ID","fieldtype":"Data","in_list_view":1},
    ...
    },
    {
        ...
        "field_order": ["s_no","date","asset_type","desc","activity","unit","avg_ef","ef_unit","co2e"],
        "fields": [
            {"fieldname":"s_no","label":"S No","fieldtype":"Int","in_list_view":1},
            {"fieldname":"date","label":"Date","fieldtype":"Date","in_list_view":1},
