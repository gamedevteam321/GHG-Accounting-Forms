...
print("🚀 Creating Project Finance DocTypes...")

required_doctypes = [
    {
        "name": "Downstream Project Finance Project Specific Item",
    ...
    {
        "name": "Downstream Project Finance Average Data Item",
        "title_field": "project_id",
        "search_fields": "date,project_id",
...
frappe.clear_cache()
frappe.db.commit()
print(f"🎉 Done. Created {created} Project Finance DocTypes (others already existed).")
