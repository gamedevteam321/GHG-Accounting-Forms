...
# exec(open(r"/Users/shobhit/Documents/Projects/Frappe/climoro-project/bench-dev/scope_code/Scope 3/Downstream/Investments/Debt Investments/doctype_console.py").read())
# create_doctypes()
